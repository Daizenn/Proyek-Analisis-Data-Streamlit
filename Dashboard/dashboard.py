...
st.bar_chart(df_season.set_index('Season'), color=["#87CEEB", "##483D8B", "#120A8F", "#1D2951"])
...
st.bar_chart(avg_weather.set_index('weather_label'), color=["#87CEEB", "#483D8B", "#120A8F"], use_container_width=True)
