...
st.bar_chart(df_season.set_index('Season'), color= df_season.set_index('Season'))
...
st.bar_chart(avg_weather.set_index('weather_label'), color=avg_weather.set_index('weather_label'), use_container_width=True)
